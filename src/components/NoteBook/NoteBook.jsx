    ...
    <article name={'noteBook' + noteBook.section} className={style.NoteBook} style={whiteSheetStyle}>
        ...
        }
      {
          noteBook.text.title.map((title, index) => (
            <h1 name={'noteBookText' + noteBook.section} className={style.NoteBookText} style={titleStyle[index]} key={index}>
              {title.content}
            </h1>
          ))
        }
      <footer name={'noteBookText' + noteBook.section} className={style.NoteBookText} style={footerStyle}>
